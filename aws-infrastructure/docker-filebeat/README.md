...
```
docker tag filebeat-custom 283179119980.dkr.ecr.eu-central-1.amazonaws.com/monitoring:filebeat
```

```
docker push 283179119980.dkr.ecr.eu-central-1.amazonaws.com/monitoring:filebeat
```