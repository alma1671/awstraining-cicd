...
```
docker tag prometheus-custom 283179119980.dkr.ecr.eu-central-1.amazonaws.com/monitoring:prometheus
```

```
docker push 283179119980.dkr.ecr.eu-central-1.amazonaws.com/monitoring:prometheus
```